...
type MediaFileFunc func(context.Context, *generated.MediaFileMutation) (generated.Value, error)

// Mutate calls f(ctx, m).
func (f MediaFileFunc) Mutate(ctx context.Context, m generated.Mutation) (generated.Value, error) {
	if mv, ok := m.(*generated.MediaFileMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *generated.MediaFileMutation", m)
}
