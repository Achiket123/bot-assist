...
func (_q *UserQuery) QueryFiles() *MediaFileQuery {
...
func (_q *UserQuery) WithFiles(opts ...func(*MediaFileQuery)) *UserQuery {
	query := (&MediaFileClient{config: _q.config}).Query()
...
//
//	client.User.Query().
//		GroupBy(user.FieldGoogleDriveID).
...
//
//	client.User.Query().
//		Select(user.FieldGoogleDriveID).
//		Scan(ctx, &v)
...
func (_q *UserQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*User, error) {
	...
	if query := _q.withFiles; query != nil {
		if err := _q.loadFiles(ctx, query, nodes,
			func(n *User) { n.Edges.Files = []*MediaFile{} },
			func(n *User, e *MediaFile) { n.Edges.Files = append(n.Edges.Files, e) }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *UserQuery) loadFiles(ctx context.Context, query *MediaFileQuery, nodes []*User, init func(*User), assign func(*User, *MediaFile)) error {
	...
	query.Where(func(s *sql.Selector) {
		...
		s.Join(joinT).On(s.C(mediafile.FieldID), joinT.C(user.FilesPrimaryKey[1]))
	...
	neighbors, err := withInterceptors[[]*MediaFile](ctx, query, qr, query.inters)
	if err != nil {
		return err
	}
